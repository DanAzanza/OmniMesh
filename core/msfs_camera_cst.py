...
try:
    from .msfs_models import CameraConfigFile, CameraDefinition
    from .msfs_transforms import format_coordinate_float
except (ImportError, ValueError):
    from core.msfs_models import CameraConfigFile, CameraDefinition
    from core.msfs_transforms import format_coordinate_float
